...
import { generateCSV, downloadCSV, generateHeadcountCSV } from '@/lib/reports/employeeReports'
import { generatePdfBlob, downloadBlob } from '@/lib/pdf/generatePdf'
import type { Employee } from '@/types'
import type { ReportColumn } from '@/lib/pdf/employeeReportPdf'
...
export function EmployeeReports({ open, onClose, employees }: Props) {
  ...
  const handleExportPDF = async () => {
    setExporting('pdf')
    try {
      const { EmployeeReportDocument } = await import('@/lib/pdf/employeeReportPdf')
